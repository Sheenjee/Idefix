...
public class MainActivity extends Activity implements View.OnClickListener {
	...
	String PersonagesSimpson[] = new String[] {"spider_cochon","cavapas", "hopital","salade","croquemitaine","idiot","singe","douche","isocele","sirop","endormi","krapabell","teloche","ensemble","puissant","tv","gym","radio","xfiles"};
